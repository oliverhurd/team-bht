...
const PDF_URLS: Record<string, string> = {
  'im-weekly-bias': '/pdfs/narrative-directional-bias.pdf',
  'im-weekly-timing': '/pdfs/narrative-timing-bias.pdf',
  'im-weekly-anchor': '/pdfs/narrative-anchor-point.pdf',
};
...
const COURSES_DATA: Record<string, CourseData> = {
  'inception-model': {
    ...
    modules: [
      {
        title: 'DISCLAIMER',
        lessons: [{ id: 'im-disclaimer', title: 'Disclaimer', completed: true }]
      },
      {
        title: 'Narrative',
        lessons: [
          { id: 'im-weekly-bias', title: "Weekly Range's Directional Bias", completed: true },
          { id: 'im-weekly-timing', title: "Weekly Range's Timing Bias", completed: true },
          { id: 'im-weekly-anchor', title: "Weekly Range's Anchor Point", completed: true },
        ]
      },
    ]
  },
