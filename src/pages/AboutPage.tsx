...
const SOCIALS = [
  {
    ...
    url: 'https://www.youtube.com/@BraveheartTrading',
    color: 'bg-red-600/10 text-red-500 border-red-500/20',
  },
  {
    icon: <Twitter size={20} />,
    name: 'X (Twitter)',
    handle: '@BraveheartTrade',
    url: 'https://x.com/BraveheartTrade',
    color: 'bg-sky-500/10 text-sky-400 border-sky-400/20',
  },
  {
    icon: <Instagram size={20} />,
    name: 'Instagram',
    handle: '@braveheart_trading',
    url: 'https://www.instagram.com/braveheart_trading',
