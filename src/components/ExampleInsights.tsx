              ...
              transition={{
                ...
                <div className="px-6 md:px-8 pb-8 pt-0 text-brave-text-secondary font-light leading-relaxed space-y-6 border-t border-brave-border/30 mt-2">
                  <div className="pt-6 space-y-6 text-base md:text-lg">
                    ...
                    <p>There should ideally be 2-3 scenarios that you can frame out if you follow step one and favor one side of the market.</p>                    <p>If things are still not clear, be willing to give up on Monday. It's like poker when the player doesn't have a good hand; they don't force it. Instead, they wait until they have a better hand. The same method applies to trading and understanding risk.</p>                    <p>When the Open does come, you'll have your clue. Those 2-3 scenarios will get boiled down to 1-2 because something gets negated.</p>                    <p className="font-bold text-brave-text-primary text-center py-6">So, remember, don't stress it and be flexible.</p>                    <p>If you follow these 3 steps, you're focusing on the essentials and not on the complexity. These steps are the key factors behind what creates the Weekly Range, rather than fixating on the SHINY BULLET.</p>                    <p>Your analysis will be lean and mean, instead of complicated and stressful. When you dial in the essentials, you'll see the complexity fall into place as well. Every piece will fit the puzzle.</p>                    <p>Rooting for your success, onwards and upwards.</p>                    <p className="font-serif text-brave-accent">Oliver</p>                  </div>                </div>              </motion.div>            }          </AnimatePresence>        </div>      </div>    </section>);
