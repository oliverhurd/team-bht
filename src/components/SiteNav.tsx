    ...
    <nav className="sticky top-0 z-50 w-full bg-[#0A0A0A]/95 backdrop-blur-sm border-b border-brave-border/50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <button
          ...
          className="hidden md:block px-4 py-2 border border-brave-border rounded-full text-xs font-medium tracking-widest uppercase text-brave-text-primary hover:bg-brave-card transition-colors">
